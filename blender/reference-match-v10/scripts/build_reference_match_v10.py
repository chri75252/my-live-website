...
def build_scene():
    ...
    # Curved electric geometry was rejected twice in actual delivery frames:
    # it either read as a white zig-zag or as a detached white dash. The forge
    # energy is now expressed by the attached warm contact-light pulse below
    # and the physical cylindrical embers emitted from the same contact point.
    # This intentionally leaves the VFX_ELECTRICITY collection empty.
    contact_events = (
