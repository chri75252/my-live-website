...
export async function createForgeIntroScene(canvas) {
  ...
  // Implement only on the feature branch after reviewing the storyboard.
  // Do not use scroll velocity, persistent skip state, broad bloom, comets,
  // external light balls, or the final hero's geometry and materials.
